...
/**
 * @ngdoc directive
 * @name tide-angular.directive:tdVisualSearch
 * @requires $compile
 * @requires underscore._
 * @requires d3service.d3
 * @requires tideLayoutTreemap
 ...
 */
 angular.module("tide-angular")
 .directive("tdVisualSearch",["$compile","_", "d3","tideLayoutTreemap", "toolTip",function ($compile,_, d3, layout, tooltip) {
   return {
    restrict: "A",
      //transclude: false,
      //template: "<div style='background-color:red' ng-transclude></div>",
      ...
      link: function (scope, element, attrs) {
        ...
        var groupsDiv = mainDiv.append("div")
          .attr("class", "row")

        var flagDiv = mainDiv.append("div")
          .attr("class", "row")
        ...
        */
        var resize = function() {
          ...
          var render = function(data) {
            ...
            var groups = inapiNest.entries(data);

            var groupNodes = flagDiv.selectAll(".groupnode")
              .data(groups, function(d) {return d.key})

            groupNodes.enter()
              .append("div")
              .attr("class", "groupnode row well")


            var countryNodes = groupNodes.selectAll(".flagnode2")
            ...
            countryNodes.enter()
              ...
              .append("img")
              .attr("src", function(d) {
                var country_code = d.country && (d.country != "null") && (d.country!=null) ? d.country.toLowerCase() : "nn";
                return "./images/flag_icons/png/"+country_code+".png";
              } )
              .on("mouseenter", function(d) {
                dataTooltip.show(d)
              })
 ...
 */
 angular.module("tide-angular")
 .directive("tdCountryBucket",["$compile","_", "d3","tideLayoutTreemap", "toolTip",function ($compile,_, d3, layout, tooltip) {
   return {
    restrict: "A",
      //transclude: false,
      //template: "<div style='background-color:red' ng-transclude></div>",
      ...
      link: function (scope, element, attrs) {
        ...
        // Div principal
        var mainDiv = d3.select(element[0])
        //.style("position", "relative")
        //.style("width", (width + margin.left + margin.right) + "px")
        //.style("height", (height + margin.top + margin.bottom) + "px")
        //.style("left", margin.left + "px")
        ...
        */
        ...
        var render = function(data) {
          ...
          var countryNodes = mainDiv.selectAll(".flagnode")
              .data(data, function(d) {return d['document-number']})
